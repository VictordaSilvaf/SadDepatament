        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
            <span>
                ...
                @if ($paginator->onFirstPage())
                    <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-zinc-500 bg-white border border-zinc-300 cursor-default leading-5 rounded-md select-none dark:bg-zinc-700 dark:text-white dark:border-zinc-500">
            ...
            <span>
                ...
                @if ($paginator->hasMorePages())
                    ...
                    @endif
                @else
                    <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-zinc-500 bg-white border border-zinc-300 cursor-default leading-5 rounded-md select-none dark:bg-zinc-700 dark:text-white dark:border-zinc-600">
                        {!! __('pagination.next') !!}
                    </span>
                @endif
            </span>
