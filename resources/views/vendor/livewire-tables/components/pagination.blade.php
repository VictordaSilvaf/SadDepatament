            ...
            <div class="mt-4 px-4 md:p-0 sm:flex justify-between items-center space-y-4 sm:space-y-0">
                <div>
                    @if ($component->paginationIsEnabled() && $component->isPaginationMethod('standard') && $rows->lastPage() > 1)
                        <p class="paged-pagination-results text-sm text-zinc-700 leading-5 dark:text-white">
                    ...
                    @else
                        <p class="total-pagination-results text-sm text-zinc-700 leading-5 dark:text-white">
                            @lang('Showing')
