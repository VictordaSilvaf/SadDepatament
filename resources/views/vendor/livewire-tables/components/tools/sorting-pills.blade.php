    ...
    <div>
        @if ($component->sortingPillsAreEnabled() && $component->hasSorts())
            <div class="mb-4 px-4 md:p-0" x-cloak x-show="!currentlyReorderingStatus">
                <small class="text-zinc-700 dark:text-white">@lang('Applied Sorting'):</small>
                ...
                >
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-zinc-100 text-zinc-800 dark:bg-zinc-200 dark:text-zinc-900">
                        @lang('Clear')
                    </span>
                </button>
            </div>
