...
<div class="@if ($component->getColumnSelectIsHiddenOnMobile()) hidden sm:block @elseif ($component->getColumnSelectIsHiddenOnTablet()) hidden md:block @endif mb-4 w-full md:w-auto md:mb-0 md:ml-2">
    ...
    >
        <div>
            <span class="rounded-md shadow-sm">
                <button
                    ...
                    type="button"
                    class="inline-flex justify-center px-4 py-2 w-full text-sm font-medium text-zinc-700 bg-white rounded-md border border-zinc-300 shadow-sm hover:bg-zinc-50 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-zinc-700 dark:text-white dark:border-zinc-600 dark:hover:bg-zinc-600"
                    aria-haspopup="true"
        ...
        <div
            ...
            class="absolute right-0 z-50 mt-2 w-full rounded-md divide-y divide-zinc-100 ring-1 ring-black ring-opacity-5 shadow-lg origin-top-right md:w-48 focus:outline-none"
        >
            <div class="bg-white rounded-md shadow-xs dark:bg-zinc-700 dark:text-white">
                ...
                >
                    <div wire:key="{{ $tableName }}-columnSelect-selectAll-{{ rand(0,1000) }}">
                        ...
                        >
                            <input
                                class="text-indigo-600 transition duration-150 ease-in-out border-zinc-300 rounded shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-zinc-900 dark:text-white dark:border-zinc-600 dark:hover:bg-zinc-600 dark:focus:bg-zinc-600 disabled:opacity-50 disabled:cursor-wait"
                                wire:loading.attr="disabled"
                                type="checkbox"
                    ...
                    @foreach ($component->getColumnsForColumnSelect() as $columnSlug => $columnTitle)
                        ...
                        >
                            ...
                            >
                                <input
                                    class="text-indigo-600 rounded border-zinc-300 shadow-sm transition duration-150 ease-in-out focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-zinc-900 dark:text-white dark:border-zinc-600 dark:hover:bg-zinc-600 dark:focus:bg-zinc-600 disabled:opacity-50 disabled:cursor-wait"
