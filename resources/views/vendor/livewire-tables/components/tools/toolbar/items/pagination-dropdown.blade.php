    ...
    <select wire:model.live="perPage" id="{{ $tableName }}-perPage"
        {{
            ...
            ->class([
                ...
                'border-zinc-300 focus:border-indigo-300 focus:ring-indigo-200 dark:bg-zinc-700 dark:text-white dark:border-zinc-600' => $component->isTailwind() && $component->getPerPageFieldAttributes()['default-colors'],
            ])
