    ...
    @if ($isTailwind)
        <div class="rounded-md shadow-sm">
            <select multiple
                ...
                class="block w-full transition duration-150 ease-in-out border-zinc-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-zinc-800 dark:text-white dark:border-zinc-600"
            >
