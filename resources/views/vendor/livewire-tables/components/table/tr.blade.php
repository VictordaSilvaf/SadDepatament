...
<tr
    ...
    wire:loading.remove
    @else
    wire:loading.class.delay="opacity-50 dark:bg-zinc-900 dark:opacity-60"
    @endif
    ...
    {{
        $attributes->merge($customAttributes)
                ->class(['bg-white dark:bg-zinc-600 dark:text-white rappasoft-striped-row' => ($component->isTailwind() && ($customAttributes['default'] ?? true) && $rowIndex % 2 === 0)])
                ->class(['bg-zinc-50 dark:bg-zinc-800 dark:text-white rappasoft-striped-row' => ($component->isTailwind() && ($customAttributes['default'] ?? true) && $rowIndex % 2 !== 0)])
