...
@if ($component->bulkActionsAreEnabled() && $component->hasBulkActions())
    ...
    @if ($component->isTailwind())
        <x-livewire-tables::table.tr.plain
            ...
            class="bg-indigo-50 dark:bg-zinc-900 dark:text-white"
        >
                ...
                <template x-if="selectedItems.length == paginationTotalItemCount">
                    <div wire:key="{{ $tableName }}-all-selected">
                        ...
                        <button
                            ...
                            type="button"
                            class="ml-1 text-blue-600 underline text-zinc-700 text-sm leading-5 font-medium focus:outline-none focus:text-zinc-800 focus:underline transition duration-150 ease-in-out dark:text-white dark:hover:text-zinc-400"
                        >
                            @lang('Deselect All')
                        </button>
                    </div>
